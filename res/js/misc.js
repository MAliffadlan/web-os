...
function changePass(){
	...
	var currentPass = prompt("Masukkan kata sandi baru","********");
	if(currentPass==initialPass){
		var newPass = prompt("Masukkan kata sandi baru");
		if(newPass.length < 8){
			alert("Kata sandi harus lebih dari 8 karakter!");
			return newPass;
		}
		else{
...
function changeName(){
	var name = prompt("Masukkan nama:",localStorage.name);
	...
	alert('Nama disimpan sebagai: "'+name+'"')
	}
